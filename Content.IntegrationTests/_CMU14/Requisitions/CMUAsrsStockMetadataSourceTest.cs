...
public sealed class CMUAsrsStockMetadataSourceTest
{
    ...
    [
        ...
        new("Vehicle Ammo", "CMUCrateVehicleAmmoLTBCannonAPFSDS", 1900, 2, 300),
        new("Vehicle Ammo", "CMUCrateVehicleAmmoLTBCannonCanister", 1900, 2, 300),
        new("Vehicle Ammo", "CMUCrateVehicleAmmoLTBCannonHE", 1900, 2, 300),
        new("Vehicle Ammo", "CMUCrateVehicleAmmoLTBCannonHEAT", 1900, 2, 300),
        new("Vehicle Ammo", "CMUCrateVehicleAmmoLTBCannonMixed", 1900, 2, 300),
        new("Vehicle Ammo", "CMUCrateVehicleAmmoLTBCannonNapalm", 1900, 2, 300),
