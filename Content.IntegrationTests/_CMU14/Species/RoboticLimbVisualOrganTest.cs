...
{
    private const string PartsPrototypeRsi = "_CMU14/Mobs/DroneAndroid/parts.rsi";
    private static readonly ResPath PartsRsi = new("/Textures/_CMU14/Mobs/DroneAndroid/parts.rsi");
