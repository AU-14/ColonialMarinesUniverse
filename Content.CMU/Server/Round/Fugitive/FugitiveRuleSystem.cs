...
using Content.Server.CMU14.Round.Antags;
using Content.Server.CMU14.Round.fugitive;
...
namespace Content.Server.CMU14.round.Fugitive;
...
public sealed partial class FugitiveRuleSystem : GameRuleSystem<FugitiveRuleComponent>
{
    ...
    [Dependency] private Content.Server.CMU14.Systems.WantedSystem _wantedSystem = default!;
