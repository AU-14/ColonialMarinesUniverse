...
public sealed partial class YautjaBowSystem : EntitySystem
{
    ...
    private static readonly SoundSpecifier SnareTriggerSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/tablehit1.ogg");
    ...
    {
        if (!_itemSlots.TryGetSlot((ent.Owner, null), ProjectileSlotId, out var slot) ||
            !slot.HasItem)
        {
            return;
        }
        ...
        _itemSlots.TryEject(ent.Owner, slot, null, out _);
    }
