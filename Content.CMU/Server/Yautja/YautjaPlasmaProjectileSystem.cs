...
public sealed partial class YautjaPlasmaProjectileSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<YautjaCasterSingleLethalProjectileComponent, AttemptTriggerEvent>(OnCasterSingleLethalBeforeTrigger);
    ...
    private void OnCasterSingleLethalBeforeTrigger(Entity<YautjaCasterSingleLethalProjectileComponent> ent, ref AttemptTriggerEvent args)
    {
    ...
    {
        return TryComp(target, out HumanoidProfileComponent? humanoid) &&
    ...
    private void ApplyCasterStun(EntityUid target, TimeSpan duration)
    {
        ...
        _stun.TryStun(target, duration, true);
