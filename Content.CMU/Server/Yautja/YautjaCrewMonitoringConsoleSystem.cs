...
public sealed partial class YautjaCrewMonitoringConsoleSystem : EntitySystem
{
        ...
        out SuitSensorStatus status)
    {
        ...
        if (TryComp<DamageableComponent>(target, out var damageable))
        {
            ...
            status.TotalDamage = damage.GetTotal().Int();
            status.OxygenDamage = YautjaCrewMonitoringMetadata.SumDamageGroup(damage, OxygenDamageTypes);
            status.ToxinDamage = YautjaCrewMonitoringMetadata.SumDamageGroup(damage, ToxinDamageTypes);
            status.BurnDamage = YautjaCrewMonitoringMetadata.SumDamageGroup(damage, BurnDamageTypes);
            status.BruteDamage = YautjaCrewMonitoringMetadata.SumDamageGroup(damage, BruteDamageTypes);
        }
