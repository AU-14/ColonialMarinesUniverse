...
public sealed partial class YautjaHealthShardComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier? SplitSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/Equipment/HealthShard/prd_health_twist_01.wav");

    [DataField]
    public SoundSpecifier? EquipSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/Equipment/HealthShard/prd_health_twist_air_02.wav");
}
...
public sealed partial class YautjaHealthShardHalfComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier? MergeSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/Equipment/HealthShard/prd_health_twist_01.wav");

    [DataField]
    public SoundSpecifier? UseSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/Equipment/HealthShard/prd_health_jab_01.wav");
