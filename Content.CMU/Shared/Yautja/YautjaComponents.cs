...
public sealed partial class YautjaBracerComponent : Component, IClothingSlots
{
    ...
    [DataField]
    public SoundSpecifier CloakOnSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/pred_cloakon_modern.wav");

    [DataField]
    public SoundSpecifier CloakOffSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/pred_cloakoff_modern.wav");
    ...
    [DataField]
    public SoundSpecifier TechDelimbSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/Weapons/WristBlades/wristblades_on.wav", AudioParams.Default.WithVolume(-8f));
...
public sealed partial class YautjaMaskComponent : Component, IClothingSlots
{
    ...
    [DataField]
    public SoundSpecifier ZoomOnSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/pred_zoom_on.ogg");

    [DataField]
    public SoundSpecifier ZoomOffSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/pred_zoom_off.ogg");
}
...
{
    [DataField]
    public SoundSpecifier PulseSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/signal.ogg");
...
public sealed partial class YautjaFalconDroneComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier DeploySound = new SoundPathSpecifier("/Audio/CMU14/Yautja/Equipment/pred_vision.wav");
}
    ...
    private static List<YautjaHuntingGroundDestination> GetDefaultHuntingGroundDestinations()
    {
        return new List<YautjaHuntingGroundDestination>
        {
            new()
            {
                ...
                MapPath = "/Maps/CMU14/HuntingGrounds/jungle_moon.yml",
            },
            new()
            {
                Id = "desert_moon",
                DisplayName = "cmu-yautja-hunting-ground-desert-moon",
                MapPath = "/Maps/CMU14/HuntingGrounds/desert_moon_caves.yml",
            },
        };
    }
...
public sealed partial class YautjaHuntPreyComponent : Component
{
    ...
    public SoundSpecifier HuntBeginSound = new SoundPathSpecifier(
        "/Audio/CMU14/Yautja/HuntingGrounds/hunt_begin.ogg");
}
...
public sealed partial class YautjaGearContainerComponent : Component, IClothingSlots
{
    ...
    [DataField]
    public SoundSpecifier InstallAttachmentSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/Equipment/pred_attach.wav");
...
public sealed partial class YautjaChainGauntletComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier HelpFinisherSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/Weapons/ChainGauntlet/hit_punch.wav");
    ...
    [DataField]
    public SoundSpecifier ExecutionTargetSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/Weapons/Melee/bone_break1.wav");

    [DataField]
    public SoundSpecifier ExecutionUserSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/Voice/Roars/pred_roar5.wav");

    [DataField]
    public SoundSpecifier ExecutionSlamSound = new SoundPathSpecifier("/Audio/CMU14/Yautja/Weapons/Melee/bang.wav");
