...
public sealed partial class YautjaCasterSystem : EntitySystem
{
    ...
    private void OnTakeAmmo(Entity<YautjaCasterComponent> ent, ref TakeAmmoEvent args)
    {
        ...
        // The bracer supplies every requested shot. The inherited battery provider
        // must not add another projectile or provide fallback ammo when power runs out.
        var requestedShots = args.Shots;
        args.Shots = 0;
        ...
        for (var shot = 0; shot < requestedShots; shot++)
        {
