...
namespace Content.Client.CMU14.Yautja.Lobby;
...
public sealed partial class YautjaProfileEditor : ScrollContainer
{
    ...
    private static readonly SoundPathSpecifier ModernCloakPreviewSound = new("/Audio/CMU14/Yautja/pred_cloakon_modern.ogg");
    private static readonly SoundPathSpecifier RetroCloakPreviewSound = new("/Audio/CMU14/Yautja/Equipment/pred_cloakon.wav");
    private static readonly ResPath BracerRsi = new("/Textures/CMU14/Yautja/bracer.rsi");
    private static readonly ResPath RankRsi = new("/Textures/CMU14/Yautja/hud_yautja.rsi");
    ...
    private void ReloadPreview(YautjaCharacterProfile yautja)
    {
        ...
        ApplyPreviewProfile(_previewDummy, yautja);
    ...
    private EntityUid? BuildSelectorDoll(YautjaCharacterProfile yautja)
    {
        ...
        ApplyPreviewProfile(dummy, yautja);
        return dummy;
    }

    private void ApplyPreviewProfile(EntityUid dummy, YautjaCharacterProfile yautja)
    {
        var profile = BuildPreviewProfile(yautja);
        _entManager.System<HumanoidProfileSystem>().ApplyProfileTo(dummy, profile);
        _entManager.System<SharedVisualBodySystem>().ApplyProfileTo(dummy, profile);
    }
