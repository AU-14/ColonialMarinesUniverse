...
cmu-paper-ciph-egg-instructions = Testing protocol: synthesize the level-two Ciphering agent from royal xenonid samples, then inject it directly into an intact ovum. Loose and planted ova are both viable, provided the specimen has not begun to open.{"\u000a"}[bold]CRITICAL: THE OVUM MUST BE INJECTED BEFORE IT BEGINS TO OPEN.[/bold]{"\u000a"}[bold]CRITICAL: THE OVUM MUST BE INJECTED BEFORE IT BEGINS TO OPEN.[/bold]
...
cmu-paper-ciph-egg-crate-notice = [head=2][bold]WEYLAND-YUTANI — CLASSIFIED OVUM HANDLING NOTICE[/bold][/head]{"\u000a"}The enclosed specimen is intended for level-two Ciphering trials. Inject the synthesized agent directly into the intact ovum. The ovum may be loose or planted, but conversion will fail after it begins opening.{"\u000a"}[bold]INJECT THE OVUM BEFORE IT BEGINS TO OPEN.[/bold]{"\u000a"}Approach planted specimens only under suitable containment; proximity may trigger a mature ovum.
