...
rmc-chembomb-lock-assembly-first = Lock the assembly with a screwdriver first.
rmc-chembomb-prepare-assembly-first = Arm the detonator assembly first.
rmc-chembomb-wrong-assembly = This casing requires a {$required} assembly.
rmc-chembomb-assembly-kind-timer = timer
rmc-chembomb-assembly-kind-proximity = proximity
rmc-chembomb-assembly-kind-signaler = signaler
rmc-chembomb-assembly-kind-double-igniter = double-igniter
