...
{
    private static readonly ProtoId<ShaderPrototype> BlurryVisionShader = "RMCBlurryVisionX";
    ...
    public RMCBlurOverlay(IEntityManager entManager)
    {
        ...
        _blurShader = _prototypeManager.Index(BlurryVisionShader).InstanceUnique();
    }
