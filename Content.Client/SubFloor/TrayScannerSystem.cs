...
public sealed partial class TrayScannerSystem : SharedTrayScannerSystem
{
    ...
    [Dependency] private EntityQuery<RMCTrayCrawlerComponent> _trayCrawlerQuery = default!;
    ...
    public override void Update(float frameTime)
    {
        ...
        var crawlerActive = _trayCrawlerQuery.TryGetComponent(player.Value, out var crawler) && crawler.Enabled;
        var canSee = crawlerActive;
        if (crawlerActive)
            range = crawler.Range;
