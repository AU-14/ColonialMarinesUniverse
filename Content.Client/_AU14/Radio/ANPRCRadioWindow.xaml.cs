...
public sealed partial class ANPRCRadioWindow : DefaultWindow
{
    ...
    public void UpdateState(ANPRCRadioState state)
    {
        ...
        // Callsign
        CallsignDisplayLabel.Text              = string.IsNullOrEmpty(state.Callsign) ? "NOT SET" : state.Callsign;
        CallsignDisplayLabel.FontColorOverride = string.IsNullOrEmpty(state.Callsign) ? TextDim : TextGood;
