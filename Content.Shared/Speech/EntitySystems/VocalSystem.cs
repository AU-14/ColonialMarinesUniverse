...
public sealed partial class VocalSystem : EntitySystem
{
    ...
    /// <summary>
    /// Sets the emote sound prototype used by a vocal entity.
    /// </summary>
    public void SetEmoteSounds(Entity<VocalComponent?> ent, ProtoId<EmoteSoundsPrototype>? protoId)
    {
        if (!Resolve(ent, ref ent.Comp) || ent.Comp.EmoteSounds == protoId)
            return;
