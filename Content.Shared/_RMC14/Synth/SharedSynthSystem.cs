...
public abstract partial class SharedSynthSystem : EntitySystem
{
    ...
    [Dependency] private SharedSynthGenerationSystem _synthGeneration = default!;
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<SynthComponent, MapInitEvent>(OnMapInit, after: [typeof(BloodstreamSystem)]);
    ...
    private void OnSynthInteractUsing(Entity<SynthComponent> synth, ref InteractUsingEvent args)
    {
        ...
        var attempt = new RMCSynthRepairToolUseAttemptEvent(user, used, synth.Owner);
        RaiseLocalEvent(synth.Owner, attempt);
        if (attempt.Handled)
        {
            args.Handled = true;
            return;
