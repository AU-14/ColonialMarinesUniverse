...
public sealed partial class XenoRageComponent : Component
{
    ...
    [DataField, AutoNetworkedField]
    public int ArmorPerRage = 3; // CMU14 modified
    ...
    [DataField, AutoNetworkedField]
    public TimeSpan RageDecayTime = TimeSpan.FromSeconds(4); // CMU14 modified
    ...
    [DataField, AutoNetworkedField]
    public FixedPoint2 HealAmount = 55; // CMU14 modified
