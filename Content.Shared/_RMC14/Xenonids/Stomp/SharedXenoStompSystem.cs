...
public sealed partial class XenoStompSystem : EntitySystem
{
    ...
    // CMU14 Begin: deps for directional stomp + obstacle checks, ported from master
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<XenoStompComponent, XenoDirectionalStompActionEvent>(OnXenoDirectionalStompAction); // CMU14
    }
    ...
    private void OnXenoStompDoAfter(Entity<XenoStompComponent> xeno, ref XenoStompDoAfterEvent args) // CMU14 method
    {
        if (args.Handled)
            return;
        ...
        // CMU14 directional dispatch, ported from master
    ...
    private void OnXenoDirectionalStompAction(Entity<XenoStompComponent> xeno, ref XenoDirectionalStompActionEvent args) // CMU14 method
    {
        if (args.Handled)
            return;
    ...
    private void DoCircularStomp(Entity<XenoStompComponent> xeno, TransformComponent xform) // CMU14 method
    {
        _receivers.Clear();
    ...
    private void DoDirectionalStomp(Entity<XenoStompComponent> xeno, TransformComponent xform, Angle direction) // CMU14 method
    {
        var origin = _transform.GetMapCoordinates(xeno);
    ...
    private bool IsBlockedByObstacle( // CMU14 method
