...
public sealed partial class XenoSmackdownSystem : EntitySystem
{
    ...
    private void OnSmackdownMelee(Entity<XenoSmackdownComponent> xeno, ref MeleeHitEvent args)
    {
        foreach (var ent in args.HitEntities)
        {
            ...
            var myDamage = _damageable.ChangeDamage(ent, _xeno.TryApplyXenoSlashDamageMultiplier(ent, xeno.Comp.Damage), origin: xeno, tool: xeno);
