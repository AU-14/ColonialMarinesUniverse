...
public sealed partial class CMGunSystem : EntitySystem
{
    ...
    [Dependency] private RMCProjectileSystem _rmcProjectileSystem = default!;
    [Dependency] private VehicleWeaponsSystem _vehicleWeapons = default!;
    ...
    private void OnWeaponAccuracyShot(Entity<RMCWeaponAccuracyComponent> weapon, ref AmmoShotEvent args)
    {
        ...
        for (var t = 0; t < args.FiredProjectiles.Count; ++t)
        {
            ...
            accuracyComponent.GunSeed = (long) (uint) t << 32 | (uint) netId;
