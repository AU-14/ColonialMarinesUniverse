...
public abstract partial class SharedGhostSystem : EntitySystem
{
    ...
    private void OnAttemptInteract(Entity<GhostComponent> ent, ref InteractionAttemptEvent args)
    {
        if (!ent.Comp.CanGhostInteract &&
            !HasComp<RMCIgnoreGhostInteractionLimitsComponent>(args.Target))
        {
            args.Cancelled = true;
        }
    }
...
/// </summary>
[Serializable, NetSerializable]
public sealed partial class WarpToRandomFollowedRequestEvent : EntityEventArgs;
/// <summary>

/// A client to server request for their ghost to be warped to a random player.
/// </summary>
[Serializable, NetSerializable]
public sealed partial class WarpToRandomRequestEvent : EntityEventArgs;
