...
public sealed partial class GameMapPrototype : IPrototype
{
    ...
    /// <summary>
    /// Additional maps loaded below the main map, in descending depth order.
    /// </summary>
    [DataField]
    public List<ResPath> MapsBelow = new();

    /// <summary>
    /// Additional maps loaded above the main map, in ascending depth order.
    /// </summary>
    [DataField]
    public List<ResPath> MapsAbove = new();

    /// <summary>
    /// Components applied to every map entity in this map's Z-level network.
    /// </summary>
    [DataField]
