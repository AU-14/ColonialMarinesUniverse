...
public sealed partial class TunableFrequencySystem : EntitySystem
{
    ...
    public void BroadcastOnFrequency(EntityUid sender, int frequency, string message)
    {
        ...
        while (query.MoveNext(out var receiver, out var tuned, out var xform))
        {
            ...
            DeliverGarbled(sender, receiver, receiver, message, frequency, senderJam, intensity);
        }
        ...
        while (anprcQuery.MoveNext(out var anprc, out var radio, out var xform))
        {
            ...
            DeliverGarbled(sender, anprc, wearer, message, frequency, senderJam, intensity);
        }

        SendToEntity(sender, sender, message, frequency);
        ...
        var chat = BuildChatMessage(sender, message, frequency);
        ...
        RadioJamIntensity rangeIntensity)
    {
        ...
        SendToEntity(sender, recipient, finalMessage, frequency);
    }
    ...
    private ChatMessage BuildChatMessage(EntityUid sender, string message, int frequency)
    {
