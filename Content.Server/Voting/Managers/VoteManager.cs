    ...
    public sealed partial class VoteManager : IVoteManager
    {
        ...
        private sealed class VoteHandle : IVoteHandle
        {
            ...
            private sealed class VoteDict : IReadOnlyDictionary<object, int>
            {
                ...
                {
                    return _reg.Entries
                        .Select((entry, i) => KeyValuePair.Create(entry.Data, entry.Votes + _reg.CarryoverVotes[i]))
                        .GetEnumerator();
                }
                ...
                public IEnumerable<int> Values => _reg.Entries.Select((entry, i) => entry.Votes + _reg.CarryoverVotes[i]);
            }
        }
